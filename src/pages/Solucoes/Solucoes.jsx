...
// --- Systems Data (Chaves para JSON de tradução) ---
const systemsData = [
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-8 lg:p-12 mt-10 border-t-4 border-[#29314A]">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-3">
              ...
              <AnimatedText text={t(`systems.${selectedSystem.key}.title`)} className="text-3xl font-extrabold text-[#333]" delay={0.1} />
            </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-10">
            <CardText className="text-xl font-semibold text-[#29314A] mb-4" delay={0.3}>
              {t("systems.mainItems")}
            </CardText>
