...
const LoginRedirectForm = ({ handleLoginRedirect, setIsLoginMode }) => (
  ...
  >
    <p className="text-sm text-gray-600 text-center">
      Retorne à tela de login para acessar sua conta.
    </p>
...
const CadastroClientes = () => {
  ...
  const handleRegisterSubmit = (e) => {
    e.preventDefault();
    setMessage('Cadastro realizado com sucesso! (Lógica real deve ser implementada)');
    setTimeout(() => {
      setMessage('');
      setIsLoginMode(true);
    }, 2500);
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-primary">
            {isLoginMode ? 'Voltar ao Login' : 'Cadastrar Cliente'}
          </h1>
