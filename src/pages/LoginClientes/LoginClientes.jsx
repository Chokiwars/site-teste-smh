...
const LoginForm = ({ handleLoginSubmit, setIsRecoveryMode, navigate }) => (
  ...
  >
    ...
    <button
      type="submit"
      className="w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-lg font-semibold text-white bg-accent hover:bg-accent/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent transition duration-150"
    >
      Entrar
    </button>
...
const LoginClientes = () => {
  ...
  const handleRecoverySubmit = (e) => {
    e.preventDefault();
    setMessage(
      'Se um email for encontrado, as instruções de recuperação de senha serão enviadas.'
    );
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">
            {isRecoveryMode
              ...
              : 'Entre na sua conta para obter mais informações de valores.'}
          </p>
        </div>
