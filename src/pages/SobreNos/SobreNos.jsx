...
function SobreNos() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start min-h-screen w-full overflow-hidden pt-32 sm:pt-40 lg:pt-48 pb-16 sm:pb-20">
      
      {/* Botão toggle de idioma */}
      ...
      <motion.div 
        ...
        animate="visible" 
        variants={fadeIn} 
        className="relative z-10 w-full px-4 sm:px-10 md:px-20 lg:px-40 text-gray-100 opacity-0 translate-y-5 transition-all duration-700"
      >
        <motion.h1 
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center text-white drop-shadow-lg mb-8 sm:mb-12" 
          variants={fadeUp}
        >
          {sobreNos.title}
        </motion.h1>
        ...
        <motion.p 
          className="text-lg sm:text-xl text-center text-gray-200 mb-12 sm:mb-16 max-w-3xl sm:max-w-4xl mx-auto leading-relaxed" 
          variants={fadeUp} 
          dangerouslySetInnerHTML={{ __html: sobreNos.intro }} 
        />
        ...
        <motion.footer 
          className="mt-12 sm:mt-20 text-center text-xs sm:text-sm text-gray-400 border-t border-white/20 pt-6 sm:pt-8" 
          variants={fadeUp}
        >
